/*******************************************************************************
 *  @ Original idea by by Binny V A, Original version: 2.00.A @ http://www.openjs.com/scripts/events/keyboard_shortcuts/ @ Original
 * License : BSD
 *  @ jQuery Plugin by Tzury Bar Yochay mail: tzury.by@gmail.com blog:
 * evalinux.wordpress.com face: facebook.com/profile.php?id=513676303
 * 
 * (c) Copyrights 2007
 *  @ jQuery Plugin version Beta (0.0.2) @ License: jQuery-License.
 * 
 * 
 * add queue support (as in gmail) e.g. 'x' then 'y', etc. add mouse + mouse
 * wheel events.
 * 
 * USAGE: $.hotkeys.add('Ctrl+c', function(){ alert('copy anyone?');});
 * $.hotkeys.add('Ctrl+c', {target:'div#editor', type:'keyup', propagate:
 * true},function(){ alert('copy anyone?');});> $.hotkeys.remove('Ctrl+c');
