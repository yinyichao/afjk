...
<body>
	<div class="frame-div1">
		<div class="frame-div2">
			<div class="title-div">
				<img src="/images/1.png" class="frame-img" /><font color="#333333"><b>${prisonName}监狱-电网</b></font>
			</div>
			<div class="check-img">
		...
		<div class="camera-div">
			<div class="camera-text">
				电网概览:共<font color="#0488ff">${page.totalRecord}</font>部,在线<font
			...
			<div class="fun-div">
				<input type="button" value="删除"
					onclick="delEwire('${code}',${page.pageNo});" />
			</div>
			<div class="fun-div">
	...
	<div id="addwin"
		...
		<form action="/plantEwire/insertEwire" method="post">
			<table align="center">
				<tr>
	...
	<div id="updatewin"
		style="display:none; position:absolute;left:50%; top:50%; width:450px; height:400px; margin-left:-200px; margin-top:-200px; background-color:#fff; text-align:center">
		<div style="margin-top:20px;">请输入信息</div>
		<form action="/plantEwire/updateEwire" method="post">
			<table align="center">
				<tr>
...
<script src="/js/running/ewire/ewireview.js"></script>
</html>
