...
<body>
	<div class="frame-div1">
		<div class="frame-div2">
			<div class="title-div">
				<img src="/images/1.png" class="frame-img" /><font color="#333333"><b>${prisonName}监狱-手机屏蔽</b></font>
			</div>
			<div class="check-img">
		...
		<div class="camera-div">
			<div class="camera-text">
				手机屏蔽概览:共<font color="#0488ff">${page.totalRecord}</font>部,在线<font
			...
			<div class="fun-div">
				<input type="button" value="删除"
					onclick="delPhone('${code}',${page.pageNo});" />
			</div>
			<div class="fun-div">
		...
		<div class="table-div" align="center">
			<table width="98%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td style="width:10%" class="td2">厂家</td>
					<td style="width:16%" class="td2">更新维护时间</td>
					<td style="width:10%" class="td2">负责民警</td>
					<td style="width:10%" class="td2">状态</td>
					<td style="width:10%" class="td2">报警记录</td>
	...
	<div id="addwin"
		...
		<form action="/plantPhone/insertPhone" method="post">
			<table align="center">
				<tr>
	...
	<div id="updatewin"
		style="display:none; position:absolute;left:50%; top:50%; width:450px; height:400px; margin-left:-200px; margin-top:-200px; background-color:#fff; text-align:center">
		<div style="margin-top:20px;">请输入信息</div>
		<form action="/plantPhone/updatePhone" method="post">
			<table align="center">
				<tr>
...
<script src="/js/running/phone/phoneview.js"></script>
</html>
