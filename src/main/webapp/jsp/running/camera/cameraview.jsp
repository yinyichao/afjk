...
<body>  
	<div class="frame-div1">
		<div class="frame-div2">
			<div class="title-div">
				<img src="/images/1.png" class="frame-img" /><font color="#333333"><b>${prisonName}监狱-摄像机</b></font>
			</div>
			<div class="check-img">
		...
		<div class="camera-div">
			<div class="camera-text">
				摄像机概览:共<font color="#0488ff">${page.totalRecord}</font>部,在线<font
			...
			<div class="fun-div">
				<input type="button" value="删除"
					onclick="delCamera('${code}',${page.pageNo});" />
			</div>
			<div class="fun-div">
		...
		<div class="table-div" align="center">
			<table width="98%" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td style="width:5%" class="td2">负责民警</td>
					<td style="width:5%" class="td2">状态</td>
					<td style="width:5%" class="td2">报警记录</td>
					<td style="width:13%" class="td1">操作</td>
				</tr>
				<c:forEach items="${page.results}" var="page" varStatus="vs">
					<tr>
						...
						<td class="td3">${page.count}</td>
						<td class="td4">
						<!--[判断，调用海康，大华摄像头  -->
							<c:if test="${page.fid=='1'}">
								<span onclick="showStartPreviewHK('${code}','${page.code}','300','200')" style="cursor:pointer ; color:#0066FF";>查看视频</span>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span onclick="showPlayBackHK('${code}','${page.code}')" style="cursor:pointer ; color:#0066FF";>查看录像</span>
							</c:if> 
							<c:if test="${page.fid=='2'}">
								<span onclick="showStartPreviewDH('${code}')" style="cursor:pointer ; color:#0066FF";>查看视频</span>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span onclick="showPlayBackDH()" style="cursor:pointer ; color:#0066FF";>查看录像</span>
							</c:if>							 
						<!--判断，调用海康，大华摄像头] -->
						</td>
					</tr>
	...
	<div id="addwin"
		...
		<form method="post" action="/plantPerimeter/insertCamera">
			<table align="center">
				<tr>
				...
				<tr>
					...
					<td align="left">
						<select name="regionId" class="checkbox">
				...
				<tr>
					...
					<td align="left">
						<select name="fid" class="checkbox">
							<option value="--请选择--">--请选择--</option>
				...
				<tr>
					...
					<td align="left"><input type="text" name="pid" value="1" class="text" /></td>
				</tr>
				<input type="hidden" name="pcode" value="${code}" />
				<tr>
					<td></td>
					<td><input type="button" value="关闭" onclick="javascript:closeAddPage();" class="button" />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="submit" value="提交" class="button" onfocus="addEqu()";/>
					</td>
				</tr>
			</table>
		</form>
	...
	<div id="updatewin"
		style="display:none; position:absolute;left:50%; top:50%; width:450px; height:400px; margin-left:-200px; margin-top:-200px; background-color:#fff; text-align:center">
		<div style="margin-top:20px;">请输入信息</div>
		<form action="/plantPerimeter/updateCamera" method="post">
			<table align="center">
				<tr>
				...
				<tr>
					<td align="right">组织：</td>
					<td align="left">
						<select name="regionId" id="region" class="checkbox">
							<c:forEach items="${organizationname}" var="org">
				...
				<tr>
					<td align="right">厂家：</td>
					<td align="left">
						<select name="fid" id="factory" class="checkbox">
							<c:forEach items="${factoryname}" var="fac">
				...
				<tr>
					<td align="right">负责人：</td>
					<td align="left">
						<input type="text" id="pid" class="text" name="pid" value=""/>
					</td>
				</tr>
...
<script src="/js/running/camera/cameraview.js"></script>
</html>
